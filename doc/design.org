...
**** DONE Unit tests
     ...
     :END:
*** INPROGRESS Grain Generator v1 requirements met [0/3]
**** INPROGRESS Write interface
     :LOGBOOK:
     CLOCK: [2019-06-28 Fri 21:54]
     :END:
**** BACKLOG Write implementation
