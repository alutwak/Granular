...
namespace audioelectric {
  ...
  template <typename T>
  Voice<T>::Voice(Waveform<T>& shape, Waveform<T>& carrier, Envelope<T>& env1, Envelope<T>& env2) :
    _graingen(shape, carrier),
    _env1(env1), _env2(env2),
    _env1_mult(0, 0, 0, 0), _env2_mult(0, 0, 0, 0)
  {
